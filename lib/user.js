...
// Returns commits count for a user, specified by the username parameter.
exports.getCommitsCount = function(username, callback) {
  // Get the uid first.
  scrapdo.getUserData('uid', { username: username }, function(data) {
    if (parseInt(data) > 0) {
      scrapdo.getUserData('commitsCount', { uid: data }, function(data) {
        callback(data);
      });
    }
    else {
